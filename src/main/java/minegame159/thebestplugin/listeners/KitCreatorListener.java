...
public class KitCreatorListener implements Listener {
    ...
    private void openKitCreatorGui(Cancellable event, Entity entity, Entity damager) {
        if (TheBestPlugin.KIT_CREATOR_ENABLED && entity.getWorld() == Bukkit.getWorld("world") && damager instanceof Player && entity instanceof ItemFrame && entity.getLocation().distance(TheBestPlugin.KIT_CREATOR_LOCATION) <= 20) {
